...
Steps to create a virtual machine (EC2 instance), Click here [[!Contributing guide](https://github.com/Patrickona/DevOps-Projects/blob/main/Lamp%20Stack/Creating%20_Server_on_AWS.md)](./Creating_Server_on_AWS.md)
